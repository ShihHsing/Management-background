<template>
    <div id="customerServiceList">
        ...
        <div class="customerServiceList_body_wrap">
            <div class="customerServiceList_body">
...
<script>
import { getUserFaqTypeListAll, getUserFaqList, deleteUserFaqInfoById } from '../../assets/axios/api.js'
export default {
    ...
    methods: {
        ...
        submitForm (current_page) {
            this.loading = true
            this.$axios.post(getUserFaqList, {
            ...
            .then(msg => {
                ...
                this.customerServiceList = data.data.faq_list // 门店数据
                // 总条数
        ...
        deleteUserFaqInfoById (id) {
            this.$axios.post(deleteUserFaqInfoById, {
                f_id: id
            })
            .then(msg => {
                const data = msg.data
