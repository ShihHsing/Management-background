<template>
    <div id="addShopFaqInfo">
        <el-col :span="24" style="height: 100%; width: 100%;">
            ...
            <div class="addShopFaqInfo_form_wrap">
                <div class="addShopFaqInfo_form_body sx_basis_scroll sx_scroll_style">
                    
                    <el-form
                        :model="addShopFaqInfoValues"
                        :rules="addShopFaqInfoValuesRules"
                        ref="addShopFaqInfoValues"
                        label-position="left"
